                    ...
                    <div class="header-info">
                        <ul>
                            ...
                            <li>
                                ...
                                ?>
                                <span><a href="<?php echo base_url().'member/login' ?>" style="color: #fff; text-decoration: none">Login</a></span>
                                &nbsp;&nbsp;Or&nbsp;&nbsp;
                                <span><a href="<?php echo base_url().'member/register' ?>" style="color: #fff;; text-decoration: none">Register</a></span>
                                <?php } else { ?>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li menuitemname="Account" class="dropdown">
                                            <a class="dropdown-toggle" style="color: #fff;" data-toggle="dropdown" href="javascript:void(0);" aria-expanded="false">
                                                Account
                                                &nbsp;<b class="caret"></b>
                                            </a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="<?php echo base_url().'member/area' ?>">
                                                        Dashboard
                                                    </a>
                                                </li>
                                                <li>
