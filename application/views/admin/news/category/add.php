        ...
        <?php echo form_open_multipart(base_url().'admin/category/save',array('onsubmit' => 'App.initForm(event, this, \'redraw\');', 'id' => 'form-data', 'class' => 'form-horizontal', 'data-parsley-validate' => 'true', 'name' => 'form', 'novalidate' => '')); ?>
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-8 col-sm-8">
                    <input class="form-control" type="text" id="category_name" name="category_name" placeholder="e.g. Tech" data-parsley-required="true">
                </div>
            </div>
            <div class="form-group row m-b-15">
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-8 col-sm-8">
                    <input class="form-control" type="text" id="meta_title" name="meta_title" data-parsley-required="false">
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-sm-4 col-form-label" for="message">Meta Keywords :</label>
                <div class="col-md-8 col-sm-8">
                    <textarea class="form-control" id="meta_keyword" name="meta_keyword" rows="4" data-parsley-range="[0,200]" placeholder="Meta keyword"></textarea>
                </div>
            </div>
            <div class="form-group row m-b-15">
                <label class="col-md-4 col-sm-4 col-form-label" for="message">Meta Description :</label>
                <div class="col-md-8 col-sm-8">
                    <textarea class="form-control" id="meta_description" name="meta_description" rows="4" data-parsley-range="[0,200]" placeholder="Meta description"></textarea>
                </div>
            </div>
