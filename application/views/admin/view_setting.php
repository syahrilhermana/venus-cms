		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_menu" data-toggle="tab" onclick="loadMenu()">Menu</a></li>
					...
					<div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_menu">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="col-md-3">
                                        <a class="btn btn-block btn-social btn-instagram" data-toggle="modal" data-target="#menuModal" onclick="loadPage('<?php echo base_url().'admin/setting/hyperlink' ?>')">
                                            <i class="fa fa-link"></i> Add Menu Hyperlink
                                        </a>
                                        <a class="btn btn-block btn-social btn-instagram" data-toggle="modal" data-target="#menuModal" onclick="loadPage('<?php echo base_url().'admin/setting/statics' ?>')">
                                            <i class="fa fa-plus-circle"></i> Add Menu Static Page
                                        </a>
                                        <a class="btn btn-block btn-social btn-instagram" data-toggle="modal" data-target="#menuModal" onclick="loadPage('<?php echo base_url().'admin/setting/custom' ?>')">
                                            <i class="fa fa-plus-circle"></i> Add Menu Custom Page
                                        </a>
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?php echo $this->config->item('project') ?>
                                        </div>
                                    </div><br/>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Model </label>
                                        <div class="col-sm-4">
                                            <?php echo $this->config->item('model') ?>
                                        </div>
                                    </div><br/>
                                    <div class="form-group">
